...
<nav class="topnav">
    <div class="topnav__left">
        ...
        <div class="topnav__links">
            ...
            <a href="<?php echo !empty($isAdminHelp) ? 'manage_notes.php' : 'all_notes.php'; ?>" class="w3-bar-item w3-button w3-hover-none w3-border-white w3-bottombar topnav-link">Notes</a>
...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar__footer">
            ...
            <a class="sidebar__item <?php echo ($current_page === 'settings') ? 'active' : ''; ?>" href="<?php echo !empty($isAdminHelp) ? 'adminprofile.php' : '#'; ?>" id="nav-settings" <?php if (empty($isAdminHelp)): ?>onclick="toggleSettingsPopup(event)"<?php endif; ?>>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <div class="account-popup" id="account-popup">
                ...
                <a class="account-popup__item <?php echo ($current_page === 'settings') ? 'account-popup__item--active' : ''; ?>" href="<?php echo !empty($isAdminHelp) ? 'adminprofile.php' : 'account_setting.php'; ?>">
