...
<header class="topbar">
    <div class="top-nav">
        <a href="admin_dashboard.php"<?= ($activeAdminPage === 'dashboard') ? ' class="active"' : '' ?>>Dashboard</a>
        <a href="admin_contributors.php"<?= ($activeAdminPage === 'contributors') ? ' class="active"' : '' ?>>Contributors</a>
    </div>
