...
// Get the current student's ID from session or default to 1
...
// Grab unique note ID identifier 
...
// ====================================================================
// 3. POST OPERATION HANDLER: NEW REVIEW/RATING ENTRIES
// ====================================================================
...
// ====================================================================
// 4. DATA COLLECTION EXTRACTION: MAIN DOCUMENT OBJECT 
// ====================================================================
...
// ====================================================================
// 5. NEW: CHECK IF THIS STUDENT HAS ALREADY PURCHASED THIS NOTE
// ====================================================================
$hasPurchased = false;
...
// ====================================================================
// 6. DATA EXTRACTION: PULL ASSIGNED STUDENT SUBMISSION REVIEWS
// ====================================================================
$comments = [];
$total_rating = 0;
...
// Compute review score aggregates
...
<head>
    ...
    <style>
        ...
        .rating-input-row label:hover,
        .rating-input-row label:hover ~ label,
        .rating-input-row input:checked ~ label {
            color: #1a1a1a;
        }
        ...
        /* White style download button variant to match purchased mock design */
        .btn-action-white {
            width: 100%;
            background-color: #ffffff;
            color: #6D3BD7;
        ...
        .btn-action-purple svg, .btn-action-white svg {
            width: 16px;
            height: 16px;
            fill: currentColor;
        }
    ...
    <div class="workspace-grid">
        ...
        <div class="sidebar-panel">
            ...
            <div class="card-widget">
                <?php if ($hasPurchased || $note['noteType'] === 'free'): ?>
                    ...
                    <a href="<?= htmlspecialchars($note['filePath']) ?>" class="btn-action-white" download>
                        <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v4M7 10l5 5 5-5M12 15V3"/></svg>
                        Download PDF
                    </a>
                <?php else: ?>
            ...
            <div class="card-widget">
                ...
                <button type="button" class="btn-action-purple" onclick="alert('Document Bookmarked!');">
