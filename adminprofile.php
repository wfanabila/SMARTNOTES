...
<div class="admin-profile-layout">
    <aside class="admin-profile-sidebar">
        ...
        <div class="admin-profile-account">
            ...
            <a class="active" href="adminprofile.php"><i class="fas fa-circle-info"></i> Account Setting</a>
            <a href="logout.php"><i class="fas fa-arrow-right-from-bracket"></i> Log Out</a>
        </div>
        <a class="admin-profile-settings" href="adminprofile.php"><i class="fas fa-sun"></i> Settings</a>
    </aside>
    <main class="admin-profile-main">
        ...
        <section class="admin-profile-content">
            ...
            <article class="admin-profile-card">
                <div class="admin-profile-summary"><div class="admin-profile-initial"><?= admin_escape($adminInitial) ?></div><div><h2><?= admin_escape($adminName) ?></h2><p><?= admin_escape($adminEmail) ?></p><span><?= admin_escape($profileRole) ?></span></div></div>
